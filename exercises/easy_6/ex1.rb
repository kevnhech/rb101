...
# rules: degree symbol for degrees, single quote for minutes, and double quote to represent seconds
#        use two digit numbers with leading zeros when formatting the minutes and seconds
#        the results may differ depending on how one rounds values, but should be within a second or two of the results shown
